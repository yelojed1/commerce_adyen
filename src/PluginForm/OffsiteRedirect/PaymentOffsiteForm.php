...
namespace Drupal\commerce_adyen\PluginForm\OffsiteRedirect;
...
class PaymentOffsiteForm extends BasePaymentOffsiteForm {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    if ($redirect_method == 'post') {
      $redirect_url = Url::fromRoute('commerce_adyen.payment_redirect_post')->toString();
    }
    else {
      ...
      $redirect_url = Url::fromRoute('commerce_adyen.payment_redirect_302', [], ['absolute' => TRUE])->toString();
    }
    $data = [
